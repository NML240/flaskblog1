...
import bcrypt
from flask_login import user_loaded_from_header, LoginManager, login_user 

# Setup CSRF secret key This needs to be first 
...
def login():
    ...
    if request.method == 'POST' and form.validate():
        ...
        user_db = User(db_username=db_username,db_hashed_password=db_hashed_password)
        login_user(user_db) 
